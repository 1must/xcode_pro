...
export function CheckIcon(){
    return (
        <svg style={{color:'green'}} viewBox="64 64 896 896" focusable="false" className="" data-icon="check" width="1em" height="1em"
...
export function QuestIcon(){
    return (
        <svg style={{color:'#08c'}} viewBox="64 64 896 896" focusable="false" className="" data-icon="question" width="1em" height="1em"
             fill="currentColor" aria-hidden="true">
            <path
